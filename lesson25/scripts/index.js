...
GetStudentInfo.prototype.present = function () {
...
GetStudentInfo.prototype.absent = function () {
  if (this.arrayOfAttendance[this.arrayOfAttendance.length - 1] !== undefined) {
    return this;
  }
...
GetStudentInfo.prototype.mark = function (mark) {
...
GetStudentInfo.prototype.summary = function () {
